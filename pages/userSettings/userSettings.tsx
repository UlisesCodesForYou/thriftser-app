                    ...
                    <div className="border-b">
                            ...
                            <a className="px-4 py-2 hover:bg-gray-100 flex">
                                <div className="text-blue-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-2xl">
                        ...
                        <Link href="#">
                            <a className="px-4 py-2 hover:bg-gray-100 flex">
                                ...
                                <div className="pl-3">
                                    ...
                                    <p className="text-xs text-gray-500">Report issues to our dedicated development
                                        team</p>
                                </div>
                            </a>
                        </Link>
                        ...
                        <Link href="#">
                            <a className="px-4 py-2 hover:bg-gray-100 flex">
                                ...
                                <div className="pl-3">
                                    ...
                                    <p className="text-xs text-gray-500">Check for any updates or neat features in the
                                        app!</p>
                                </div>
                            </a>
                        </Link>
                        <Link href="#">
                            <a className="px-4 py-2 hover:bg-gray-100 flex">
                                ...
                                <div className="pl-3">
                                    ...
                                    <p className="text-xs text-gray-500">Add users via QR Code or check into a
                        ...
                        <Link href="#">
                            <a className="px-4 py-2 hover:bg-gray-100 flex">
                                ...
                                <div className="pl-3">
                                    <p className="text-sm font-medium text-gray-800 leading-none">COVID-19 Information
                                        Center</p>

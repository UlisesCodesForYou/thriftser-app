        ...
        <>
            ...
            <div className="bg-blue-600 h-screen">
                <div className="sticky w-full top-0 h-10">
                    <header className='text-lg text-left font-bold text-white bg-blue-600 ml-4'>Notifications</header>
                </div>

                <div className="w-full h-auto relative bg-blue-600">
                    <div className="bg-white  px-5 py-3.5 rounded-lg shadow hover:shadow-xl max-w-sm mx-auto transform hover:-translate-y-[0.125rem] transition duration-100 ease-linear mb-3">
